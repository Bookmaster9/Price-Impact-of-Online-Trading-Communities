...
plt.suptitle("Sell to Close Message Contracts Only", fontsize=20)
# Make suptitle bigger
plt.savefig("plots/selltocloseonly_averages.png", dpi = 300, bbox_inches = "tight")
plt.show()
