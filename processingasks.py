...
for id in valid_ids:
    ...
    for offset in ["-2", "-1", "0", "+1", "+2"]:
        weighted_avg_price[offset] = data[offset]["ask"]
...
#     np.save(f"processedasks/avg_change_{offset}.npy", avg_change[offset])
#     np.save(f"processedasks/std_change_{offset}.npy", std_change[offset])
# np.save("processedasks/valid_id_order.npy", np.array(valid_id_order))
